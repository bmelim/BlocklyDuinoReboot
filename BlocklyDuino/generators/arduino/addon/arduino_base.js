...
Blockly.Arduino['arduino_base_base_delay'] = function(block) {
  var delay_time = Blockly.Arduino.valueToCode(this, 'DELAY_TIME', Blockly.Arduino.ORDER_ATOMIC) || '1000'
  var code = 'delay(' + delay_time + ');\n';
  return code;
};

Blockly.Arduino['arduino_base_base_map'] = function(block) {
...
*/
Blockly.Arduino['arduino_base_servo_move'] = function(block) {
...
Blockly.Arduino['arduino_base_servo_read_degrees'] = function(block) {
  var dropdown_pin = block.getFieldValue('PIN');
