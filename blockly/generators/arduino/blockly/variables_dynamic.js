...
Blockly.Arduino['variables_get_dynamic'] = function(block) {
  // Variable getter.
...
Blockly.Arduino['variables_set_dynamic'] = function(block) {
  // Variable setter.
...
Blockly.Arduino['variables_get_panda'] = function(block) {
  // Variable getter.
  var code = Blockly.Arduino.variableDB_.getName(block.getFieldValue('VAR'),
      Blockly.Variables.NAME_TYPE);
  return [code, Blockly.Arduino.ORDER_ATOMIC];
...
Blockly.Arduino['variables_set_panda'] = function(block) {
  // Variable setter.
  var argument0 = Blockly.Arduino.valueToCode(block, 'VALUE',
      Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
  var varName = Blockly.Arduino.variableDB_.getName(
